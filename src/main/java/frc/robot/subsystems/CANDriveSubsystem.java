...
public class CANDriveSubsystem extends SubsystemBase {
  ...
  public CANDriveSubsystem() {
    ...
    // NOTE: The mount pose may already be calibrated via the Phoenix Tuner X GUI.
    // This code applies it programmatically just in case. TEST on the robot to
    // confirm the heading reads correctly — if the GUI config is correct you may
    // not need this, but it shouldn't hurt to have it here as a safety net.
