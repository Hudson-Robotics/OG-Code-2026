...
public class DynamicClimbDown extends Command {

  private final ClimberSubsystem climberSubsystem;
  private final DoubleSupplier triggerValue;

  public DynamicClimbDown(ClimberSubsystem climberSubsystem, DoubleSupplier triggerValue) {
  ...
  @Override
  public void execute() {
    // Use the trigger value as negative to climb down
